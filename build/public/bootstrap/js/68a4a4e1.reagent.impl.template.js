...
var G__29692 = o;
reagent.impl.template.goog$module$goog$object.set(G__29692,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__29854__delegate = function (args){
...
while (G__29855__i < G__29855__a.length) {G__29855__a[G__29855__i] = arguments[G__29855__i + 0]; ++G__29855__i;}
  args = new cljs.core.IndexedSeq(G__29855__a,0,null);
} 
return G__29854__delegate.call(this,args);};
G__29854.cljs$lang$maxFixedArity = 0;
G__29854.cljs$lang$applyTo = (function (arglist__29856){
var args = cljs.core.seq(arglist__29856);
return G__29854__delegate(args);
});
...
var G__29715 = o;
reagent.impl.template.goog$module$goog$object.set(G__29715,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__29857__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__29858__i < G__29858__a.length) {G__29858__a[G__29858__i] = arguments[G__29858__i + 0]; ++G__29858__i;}
  args = new cljs.core.IndexedSeq(G__29858__a,0,null);
} 
return G__29857__delegate.call(this,args);};
G__29857.cljs$lang$maxFixedArity = 0;
G__29857.cljs$lang$applyTo = (function (arglist__29859){
var args = cljs.core.seq(arglist__29859);
return G__29857__delegate(args);
});
...
var G__29719 = props;
var G__29719__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__29719,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__29719);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__29719__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5045__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__29721 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__29721,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__29721;
}
})(),id_class);
...
var G__29722 = (cljs.core.count(argv) - first_child);
switch (G__29722) {
case (0):
...
var vec__29752 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29752,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29752,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29752,(2),null);
...
var temp__5808__auto___29875 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___29875 == null)){
} else {
var key_29876 = temp__5808__auto___29875;
(jsprops.key = key_29876);
}
...
var temp__5808__auto___29877 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___29877 == null)){
} else {
var key_29878 = temp__5808__auto___29877;
(jsprops.key = key_29878);
}
...
var temp__5808__auto___29881 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___29881 == null)){
} else {
var key_29882 = temp__5808__auto___29881;
(jsprops.key = key_29882);
}
...
var temp__5808__auto___29885 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___29885 == null)){
} else {
var key_29886 = temp__5808__auto___29885;
(jsprops.key = key_29886);
}
...
var temp__5808__auto___29888 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___29888 == null)){
} else {
var key_29889 = temp__5808__auto___29888;
(jsprops.key = key_29889);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__29816_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__29816_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__29826 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29826,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29826,(1),null);
...
break;
default:
var G__29891 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__29892 = compiler;
v = G__29891;
compiler = G__29892;
continue;
...
return reagent.impl.template.expand_seq(x,this$);
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template29842 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template29842 = (function (opts,id,fn_to_element,meta29843){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template29842.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_29844,meta29843__$1){
var self__ = this;
var _29844__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template29842(self__.opts,self__.id,self__.fn_to_element,meta29843__$1));
}));

(reagent.impl.template.t_reagent$impl$template29842.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_29844){
var self__ = this;
var _29844__$1 = this;
return self__.meta29843;
}));

(reagent.impl.template.t_reagent$impl$template29842.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template29842.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template29842.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template29842.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template29842.getBasis = (function (){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"meta29843","meta29843",-221288165,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template29842.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template29842.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template29842");

(reagent.impl.template.t_reagent$impl$template29842.cljs$lang$ctorPrWriter = (function (this__5330__auto__,writer__5331__auto__,opt__5332__auto__){
return cljs.core._write(writer__5331__auto__,"reagent.impl.template/t_reagent$impl$template29842");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template29842.
 */
reagent.impl.template.__GT_t_reagent$impl$template29842 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template29842(opts__$1,id__$1,fn_to_element__$1,meta29843){
return (new reagent.impl.template.t_reagent$impl$template29842(opts__$1,id__$1,fn_to_element__$1,meta29843));
});

}

return (new reagent.impl.template.t_reagent$impl$template29842(opts,id,fn_to_element,cljs.core.PersistentArrayMap.EMPTY));
});
