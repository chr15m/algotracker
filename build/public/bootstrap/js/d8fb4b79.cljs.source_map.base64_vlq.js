...
var digit_26467 = (vlq & cljs.source_map.base64_vlq.vlq_base_mask);
var vlq_26468__$1 = (vlq >>> (5));
while(true){
if((vlq_26468__$1 > (0))){
var digit_26469__$1 = (digit_26467 | cljs.source_map.base64_vlq.vlq_continuation_bit);
sb.append(cljs.source_map.base64.encode(digit_26469__$1));

var G__26470 = (vlq_26468__$1 & cljs.source_map.base64_vlq.vlq_base_mask);
var G__26471 = (vlq_26468__$1 >>> (5));
digit_26467 = G__26470;
vlq_26468__$1 = G__26471;
continue;
} else {
sb.append(cljs.source_map.base64.encode(digit_26467));
}
break;
}
...
var G__26473 = i__$1;
var G__26474 = result__$1;
var G__26475 = shift__$1;
i = G__26473;
result = G__26474;
shift = G__26475;
continue;
