...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_25572 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_25572(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_25576 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_25576(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_25578 = (function (reader,ch){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_25578(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_25579 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_25579(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_25584 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_25584(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_25586 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_25586(reader);
}
});
...
var G__25628 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__25629 = s.append(c);
c = G__25628;
s = G__25629;
continue;
}
